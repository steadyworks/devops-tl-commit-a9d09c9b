...
--
-- Name: share_delivery_event; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.share_delivery_event AS ENUM (
    'queued',
    'sent',
    'failed'
);
...
--
-- Name: TYPE share_delivery_event; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: share_overall_status; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.share_overall_status AS ENUM (
    'pending',
    'scheduled',
    'sent_some',
    'sent_all',
...
--
-- Name: TYPE share_overall_status; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: share_delivery_attempts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE share_delivery_attempts; Type: COMMENT; Schema: public; Owner: -
--
...
CREATE TABLE public.shares (
    ...
    access_policy public.share_access_policy DEFAULT 'link_open'::public.share_access_policy NOT NULL,
    notes text,
    overall_status public.share_overall_status DEFAULT 'pending'::public.share_overall_status NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT chk_shares_auth_requires_identity CHECK (((access_policy <> 'recipient_must_auth'::public.share_access_policy) OR (recipient_user_id IS NOT NULL)))
);
...
--
-- Name: share_delivery_attempts share_delivery_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.share_delivery_attempts
    ADD CONSTRAINT share_delivery_attempts_pkey PRIMARY KEY (id);
...
--
-- Name: idx_share_delivery_attempts_channel_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_share_delivery_attempts_channel_created ON public.share_delivery_attempts USING btree (share_channel_id, created_at);
...
--
-- Name: idx_shares_overall_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shares_overall_status ON public.shares USING btree (overall_status);
...
--
-- Name: share_delivery_attempts share_delivery_attempts_share_channel_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.share_delivery_attempts
    ADD CONSTRAINT share_delivery_attempts_share_channel_id_fkey FOREIGN KEY (share_channel_id) REFERENCES public.share_channels(id) ON DELETE CASCADE;
